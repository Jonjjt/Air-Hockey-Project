...
//hsinhua dangerous test
// std::shared_ptr<Property> TcamImage::get_exposure_value()
// {
//     std::shared_ptr<Property> ExposureAuto = NULL;
//     std::shared_ptr<Property> ExposureValue = NULL;
//     ExposureAuto = TcamCamera::get_property("Exposure Auto");

//     int Auto =2;
//     // if(ExposureAuto != NULL){
//     //     ExposureAuto->get(this,Auto);
//     // }
